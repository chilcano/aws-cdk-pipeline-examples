...
export class LambdaStack extends cdk.Stack {
  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    // lambdaversion
    //const version = fn.addVersion(new Date().toISOString());  // <--- this is deprecated
    // https://docs.aws.amazon.com/cdk/latest/guide/codepipeline_example.html#codepipeline_example_lambdastack
    const version2 = fn.currentVersion;
