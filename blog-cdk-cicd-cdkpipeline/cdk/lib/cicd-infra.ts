...
export class CicdInfraStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const cdkOutputArtifact = new codepipeline.Artifact();
        ...
        // https://github.com/binxio/blog-cdk-cicd-cdkpipeline
        // https://github.com/chilcano/blog-cdk-cicd-cdkpipeline
    ...
    const pipeline = new pipelines.CdkPipeline(this, 'CdkPipeline', {
      ...
      sourceAction: new codepipeline_actions.GitHubSourceAction({
        ...
        oauthToken: cdk.SecretValue.secretsManager('github-token-playground-mtls-authn', {jsonField: 'token'}),
